...
* If the gene is not defined in the GTF, all the overlapping isoforms on the same starnd will be considered one locus (unstranded isoforms will be included with both strands)
